...
public:
     ...
     */
    virtual bool validarCriar(string& codigoReserva, string& emailHospede, string& codigoHotel, string& dataChegada, string& dataPartida) = 0;
     ...
     */
    virtual bool validarEditarDatas(string& dataChegada, string& dataPartida) = 0;
     ...
     */
    virtual bool validarCancelar(string& codigoReserva) = 0;
};
